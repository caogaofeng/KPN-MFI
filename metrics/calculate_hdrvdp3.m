function output = hdr_vdp3(LQ_img_path, GT_img_path)
    addpath('D:\matlab_project\hdrvdp-3.0.6');
...
%    GT_img_path = '...';
    ...
    ppd = hdrvdp_pix_per_deg( 50, [1920 1080], 0.5 );
    res = hdrvdp3('side-by-side', LQ_img, GT_img, 'rgb-bt.2020', ppd, {'disable_lowvals_warning', true, 'rgb_display', 'led-lcd-wcg'});
    output = res.Q;
end
